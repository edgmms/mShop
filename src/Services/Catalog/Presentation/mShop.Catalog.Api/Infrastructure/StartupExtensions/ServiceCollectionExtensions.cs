...
namespace mShop.Catalog.Api.Infrastructure.StartupExtensions
{
    ...
    public static class ServiceCollectionExtensions
    {
            ...
            IConfiguration configuration, IHostingEnvironment webHostEnvironment)
        {
            ...
            services.ConfigureStartupConfig<CatalogDbSettings>(configuration.GetSection("CatalogDbSettings"));
        ...
        public static IMvcBuilder AddCatalogMvc(this IServiceCollection services)
        {
            ...
            mvcBuilder.AddFluentValidation(configuration =>
            {
                ...
                var assemblies = mvcBuilder.PartManager.ApplicationParts
                    .OfType<AssemblyPart>()
                    .Where(part => part.Name.StartsWith("mShop.Catalog", StringComparison.InvariantCultureIgnoreCase))
        ...
        public static void AddCatalogSwaggerGen(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "mShop Catalog Api", Version = "v1" });
