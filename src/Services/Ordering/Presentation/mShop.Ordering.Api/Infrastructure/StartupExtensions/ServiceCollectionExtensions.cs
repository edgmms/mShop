...
namespace mShop.Ordering.Api.Infrastructure.StartupExtensions
{
    ...
    public static class ServiceCollectionExtensions
    {
            ...
            IConfiguration configuration, IHostingEnvironment webHostEnvironment)
        {
            ...
            services.ConfigureStartupConfig<OrderingDbSettings>(configuration.GetSection("OrderingDbSettings"));
        ...
        public static IMvcBuilder AddOrderMvc(this IServiceCollection services)
        {
        ...
        public static void AddOrderSwaggerGen(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "mShop Order Api", Version = "v1" });
