...
namespace mShop.Discount.Api.Infrastructure.StartupExtensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IMvcBuilder AddDiscountMvc(this IServiceCollection services)
        {
        ...
        public static void AddDiscountSwaggerGen(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "mShop Discount Api", Version = "v1" });
