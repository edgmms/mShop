...
namespace mShop.Discount.Grpc.Infrastructure.Mapper.Extensions
{
    public static class AutoMapperExtensions
    {
        ...
        public static TModel ToModel<TModel>(this BaseEntity entity)
        {
            if (entity == null)
        ...
        /// <param name="entity">Entity to map from</param>
        /// <returns>Mapped model</returns>
        public static TModel ToModel<TModel>(this Task<BaseEntity> entity)
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
