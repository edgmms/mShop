...
namespace mShop.Basket.Core.Infrastructure
{
    /// <summary>
    /// A class that finds types needed by MShop by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected IMShopFileProvider _fileProvider;

        #endregion

        #region Ctor

        public AppDomainTypeFinder(IMShopFileProvider fileProvider = null)
        {
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into MShop.
        /// </returns>
        ...
        /// <summary>Gets or sets whether MShop should iterate assemblies in the app domain when loading MShop types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that MShop assemblies aren't investigated (e.g. by not including something like "^MShop|..." you may break core functionality.</remarks>
